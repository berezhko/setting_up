                    ...
                    result += '''
  {
   ...
   "source": [
    "df_''' + file_md5_name[:6] + ''' = po(\\"''' + f + '''\\", ''' + end_command + parametrs + ''')"
                ...
                if f.find("15 секунд") > -1: # if f.find("псс") > -1:
                    result += '''
  {
   "cell_type": "code",
   "execution_count": null,
   ...
   "outputs": [],
   "source": [
    "getIndex(df_''' + file_md5_name[:6] + '''[\\"Uf\\"])"
   ]
  },'''  
                    result += '''
  {
   ...
   "outputs": [],
   "source": [
    "df_''' + file_md5_name[:6] + '''_up = po(\\"''' + f + '''\\", ''' + end_command + parametrs + ''')"
   ]
  },'''
                    result += '''
  {
   ...
   "outputs": [],
   "source": [
    "df_''' + file_md5_name[:6] + '''_dw = po(\\"''' + f + '''\\", ''' + end_command + parametrs + ''')"
   ]
  },'''
    return result
